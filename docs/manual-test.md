...
`D:\AI\AdobePlugin\Photoshop\layer-organization-rename-panel`
...
4. Photoshop のホスト上で panel または script shell が読み込めることを確認する。
...
- docs ZIP が `dist/layer-organization-rename-panel-docs.zip` に存在する。
